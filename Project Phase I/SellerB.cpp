...
void create_tcp_server() {
    ...
    cout << "<SellerB> has TCP port " << SellerB_TCP_PORT << " and IP address " << inet_ntoa(*(struct in_addr*)he->h_addr) << " for Phase I part 4" << endl;
}
...
void create_tcp_client() {
    ...
    //cout << "<SellerB> has TCP port " << SellerB_TCP_PORT << " and IP address " << ipaddr << " for Phase I part 1" << endl;
}
...
void send_to_agent() {
    ...
    printf("<SellerB> has TCP port %d and IP address %s for Phase I part 1\n", portnum, ipaddr);
    cout << "<SellerB> is now connected to the <Agent1>" << endl;
...
void receive_from_agent() {
    ...
    sleep(1);
    cout << "End of Phase I part 4 for <SellerB>" << endl;
}
